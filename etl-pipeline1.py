...
email_failed = "jonathansales14@gmail.com"
...
def _extract():
    ...
    engine_mysql_oltp = sqlalchemy.create_engine('mysql+pymysql://root:localhost/employees')
...
def _load():
    ...
    engine_postgresql_olap = sqlalchemy.create_engine('postgres+psycopg2://postgres:localhost/employees')
